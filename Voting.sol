...
contract Voting{
    ...
    function voteTo(address _candidateAddress ,address _organizer, address _voter,uint _id) public {
      ...
      function displayCandidateDetails(address _organizer,uint _id, uint _index) public view returns(string memory name , address candidateAddress, string memory party, uint votesGained, uint totalCandidates ){
